...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'first_name.max' => 'Il campo Nome non deve superare 64 caratteri.',
        'last_name.min' => 'Il campo Cognome deve contenere almeno 3 caratteri.',
        'last_name.max' => 'Il campo Cognome non deve superare 64 caratteri.',
        'email.required' => 'Il campo Email è obbligatorio.',
        'email.max' => 'Il campo Email non deve superare 32 caratteri.',
        'email.email' => 'Inserisci un indirizzo email valido.',
        'email.unique' => 'Questo indirizzo email è già stato utilizzato.',
        'date_of_birth.date' => 'Inserisci una data valida.',
        'date_of_birth.before_or_equal' => 'Devi essere nato prima del 2005 per registrarti.',
        'password.required' => 'Il campo Password è obbligatorio.',
        'password.min' => 'Il campo Password deve contenere almeno 8 caratteri.',
        'password.max' => 'Il campo Password non deve superare 64 caratteri.',
    ],
